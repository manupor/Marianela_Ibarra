...
export default function Recursos() {
  useSEO({
    title: 'Recursos · Entrevistas y videos sobre alimentación intuitiva',
    description: 'Entrevista en YouTube, contenido en Instagram y recursos gratuitos sobre alimentación intuitiva, enfoque no centrado en peso y trastornos de conducta alimentaria.',
    keywords: 'entrevista alimentación intuitiva, video nutricionista no dieta, YouTube alimentación consciente, Marianela Ibarra entrevista, recursos nutrición sin dietas',
    path: '/recursos',
    jsonLdId: 'ld-recursos',
  })
  return (
