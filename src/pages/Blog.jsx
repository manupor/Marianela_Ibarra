    ...
    <div className="pt-24 pb-10">
      ...
      <section className="page-container mb-10">
        ...
        <p className="section-subtitle max-w-xl">
          Comparto información sobre cómo mejorar tu relación con la comida y el cuerpo — desde el conocimiento y desde la experiencia personal.
        </p>
        </FadeUp>
      </section>
      ...
      <section className="page-container">
          ...
          <h2 className="font-display text-2xl text-gray-800 mb-3">¿Querés más tips?</h2>
