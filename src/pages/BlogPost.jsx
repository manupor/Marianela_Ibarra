...
export default function BlogPost() {
  ...
  useSEO({
    ...
    description: post ? post.excerpt : 'El artículo solicitado no existe.',
    keywords: post ? [post.category, ...post.tags, 'nutrición', 'alimentación consciente'].join(', ') : undefined,
    path: `/blog/${slug || ''}`,
    image: post && post.image,
    type: 'article',
    jsonLdId: 'ld-blogpost',
    jsonLd: post ? {
      ...
      author: { '@type': 'Person', name: 'Marianela Ibarra', url: 'https://www.mibarranutricion.com/sobre-mi' },
      publisher: {
        '@type': 'Organization',
        name: 'Marianela Ibarra Nutrición',
        logo: { '@type': 'ImageObject', url: 'https://www.mibarranutricion.com/marianela.jpg' },
      },
      mainEntityOfPage: { '@type': 'WebPage', '@id': `https://www.mibarranutricion.com/blog/${post.slug}` },
    } : undefined,
  })
